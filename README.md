...
Commands can be specified in a file ```terminal_commands.lua``` inside a ```.nvim``` directory. The file must return a table. The keys are the extensions of the files for which commands should be specified.
