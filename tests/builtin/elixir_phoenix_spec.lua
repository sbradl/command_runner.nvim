...
describe("command_runner.builtin.elixir_phoenix", function()
	...
	describe("phx new", function()
		...
		it("should build the phx.new command rooted at the buffer's directory", function()
			local out = cmd.cmd(data .. "/bare/app.ex")
